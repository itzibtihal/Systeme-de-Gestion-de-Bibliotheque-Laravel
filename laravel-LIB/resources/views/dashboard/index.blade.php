    ...
    <div class="d-flex" id="wrapper">
        ...
        <div class="bg" id="sidebar-wrapper">
            ...
            <div class="list-group list-group-flush my-3">
                <a href="{{route('dashboard.index')}}" class="list-group-item list-group-item-action bg-transparent second-text active"><i
                ...
                <a href="{{route('reservations.index')}}" class="list-group-item list-group-item-action bg-transparent second-text fw-bold"><i
