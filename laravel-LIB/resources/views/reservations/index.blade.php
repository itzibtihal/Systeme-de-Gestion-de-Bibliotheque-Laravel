  ...
  <div class="d-flex" id="wrapper">
    ...
    <div class="bg" id="sidebar-wrapper">
      ...
      <div class="list-group list-group-flush my-3">
        ...
        <a href="{{route('dashboard.index')}}" class="list-group-item list-group-item-action bg-transparent second-text fw-bold active"><i class="fas fa-plus me-2"></i>Reservation</a>
