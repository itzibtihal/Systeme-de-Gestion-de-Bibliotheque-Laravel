...
<body id="page-top">
    ...
    <!-- Masthead-->
    <header class="masthead" style="background-image: url('https://wallpaperaccess.com/full/253342.jpg');">
        ...
        <div class="container-fluid p-0">
            <div class="row g-0">
                <div class="col-lg-4 col-sm-6">
                    <a class="portfolio-box" href="{{ asset('img/book1.jpg') }}" title="Project Name">
                ...
                <div class="col-lg-4 col-sm-6">
                    <a class="portfolio-box" href="{{ asset('img/book2.jpg') }}" title="Project Name">
                ...
                <div class="col-lg-4 col-sm-6">
                    <a class="portfolio-box" href="{{ asset('img/book3.jpg') }}" title="Project Name">
                        <img class="img-fluid" src="../img/book3.jpg" alt="..." />
                        <div class="portfolio-box-caption">
                ...
                <div class="col-lg-4 col-sm-6">
                    <a class="portfolio-box" href="{{ asset('img/book4.jpg') }}" title="Project Name">
                        <img class="img-fluid" src="{{ asset('img/book4.jpg') }}" alt="..." />
                        <div class="portfolio-box-caption">
                            <div class="project-category text-white-50">Romance</div>
                ...
                <div class="col-lg-4 col-sm-6">
                    <a class="portfolio-box" href="{{ asset('img/book5.jpg') }}" title="Project Name">
                ...
                <div class="col-lg-4 col-sm-6">
                    <a class="portfolio-box" href="{{ asset('img/book3.jpg') }}" title="Project Name">
                        <img class="img-fluid" src="../img/book6.jpg" alt="..." />
    ...
    <footer class="bg-light py-5">
        <div class="container px-4 px-lg-5">
            <div class="small text-center text-muted">Copyright &copy; 2024 - SmartLibra</div>
        </div>
    </footer>
    <!-- Bootstrap core JS-->
